/**
 * payment-handler-polyfill webpack build rules.
 *
...
const outputs = [
  // core jsonld library
  {
    ...
    filenameBase: 'payment-handler-polyfill'
  },
  /*
...
outputs.forEach((info) => {
  ...
  const common = {
    ...
    entry: {
      'payment-handler-polyfill': info.entry
    },
    module: {
      rules: [
        {
          ...
          include: [{
            ...
            include: /(node_modules\/web-request-rpc)/
          }],
          /*
          use: {
            loader: 'babel-loader',
